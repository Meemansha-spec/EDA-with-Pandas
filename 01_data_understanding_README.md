...
This project is designed as a job-focused business analytics case study.

The goal is not only to create charts or dashboards, but to show the ability to:

* Understand raw business data
* Identify churn and revenue risks
* Translate data into business questions
* Prepare data for decision-making
* Build a strong foundation for SQL, DAX, and Power BI analysis
...
The data understanding phase shows that the telecom churn dataset contains strong business value. The dataset can support analysis of churn behavior, revenue leakage, customer segmentation, contract performance, service quality, and retention strategy.

Early findings suggest that churn is concentrated among high monthly charge customers, short-tenure customers, month-to-month contract users, fiber optic customers, and customers leaving due to competitor-related reasons.

These insights will guide the next stages of the project: data cleaning, exploratory data analysis, SQL business analysis, DAX KPI creation, and Power BI dashboard development.
